...
def run():
    ...
    if accounts.get(labeler_name) == passcode:
        ...
        with st.sidebar:
            ...
            st.title("标记帮助")
            helps = st.selectbox(
                'HELP!', ('male', 'afro', 'bob', 'bowl', 'buzz', 'caesar',
        ...
        with form:
            ...
            #cols = st.columns((4))
            if dup == 1:
                race = colsA[0].selectbox('人种 race', ('请选择', 'asian', 'EU/NA'),
                                          index=race_list.index(
            ...
            if dup == 1:
                ...
                background = cols[1].selectbox('背景情况 background',
                                               ('请选择', 'Good', 'Bad'))
